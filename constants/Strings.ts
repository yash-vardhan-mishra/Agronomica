export default {
    loginPrompt: 'Welcome back! Glad to see you, Again!',
    loginBottomPrompt: 'Already have an account?',
    loginBottomPromptAction: 'Login Now',
    signUpPrompt: 'Hello! Register to get started',
